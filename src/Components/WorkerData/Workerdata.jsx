...
function Workerdata({ worker }) {
  ...
  const AvHours = ["07:00", "07:30", "08:00", "08:30", "09:00", "09:30", "10:00", "10:30", "11:00",
  ...
  const filteredHours = AvHours.filter((index) => index > (timeValue.getHours() + ":" + timeValue.getMinutes()))
      ...
      <div className="timeOrder">
        <div className="timePicker">
          ...
          >
            ...
            {(
              (timeValue.getDate() === jobDate.getDate() && timeValue.getMonth() === jobDate.getMonth())
                ? filteredHours
                : AvHours
            ).map((i) => (
